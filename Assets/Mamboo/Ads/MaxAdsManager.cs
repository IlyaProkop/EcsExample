...
public class MaxAdsManager : MonoBehaviour,IMediationAdManager
{
    ...
    public const string bannerAdUnit = "your Android banner unit id";
    public const string interstitialAdUnit = "your Android interstitial unit id";
    public const string rewardedAdUnit = "your Android rewarded unit id";
#endif
